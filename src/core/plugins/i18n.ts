...
const messages = {
  ...
  pt: {
    ...
    multiStepSignUp: "Cadastro em Múltiplas Etapas",
    error404: "Erro 404",
    error500: "Erro 500",
    apps: "Aplicativos",
    chat: "Chat",
    ...
    drawerChat: "Chat de Gaveta",
    widgets: "Widgets",
    widgetsLists: "Listas",
    widgetsStatistics: "Estatísticas",
    widgetsCharts: "Gráficos",
    widgetsMixed: "Misturado",
    widgetsTables: "Tabelas",
    widgetsFeeds: "Feeds",
    changelog: "Registro de Alterações",
    docsAndComponents: "Documentos & Componentes",
    megaMenu: "Mega Menu",
    exampleLink: "Link Exemplo",
    modals: "Modais",
    general: "Geral",
    inviteFriends: "Convidar Amigos",
    viewUsers: "Ver Usuários",
    upgradePlan: "Plano de Upgrade",
    shareAndEarn: "Compartilhar & Ganhar",
    forms: "Formulários",
    newTarget: "Novo Objetivo",
    newCard: "Novo Cartão",
    ...
    customersListing: "Lista de Clientes",
